		...
		>
			...
			>
				...
				<Headline tag="p" size="h4" color="primary" collapse>
					...
					with passions for system-thinking and design systems, design
					technology, and shredding the saxophone, currently based in
					Seattle, Washington.
				</Headline>
				<Paragraph color="secondary" collapse>
					I&apos;m currently helping to empower a broad range of
					designers, engineers, and creative thinkers on the Design
					System team at{' '}
					<InlineLink
						type="external"
						target="_blank"
